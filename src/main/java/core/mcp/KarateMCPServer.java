...
public class KarateMCPServer {
    private static ChromeCustom driver;
    private static final ScriptRecorder recorder = ScriptRecorder.getInstance();
    ...
    private static McpServerFeatures.SyncToolSpecification createTool(String name, String description, 
